        ...
        <div className="flex items-center justify-between">
          ...
          {content && (
            <button
              ...
              className="flex items-center justify-center w-8 h-8 bg-gradient-to-r from-[#00ad25] to-[#04ff50] text-white rounded-lg hover:from-[#009922] hover:to-[#03e047] transition-all duration-200 cursor-pointer"
            >

        ...
        <div className="flex items-center justify-between">
          ...
          {content && (
            <button
              ...
              className="flex items-center justify-center w-8 h-8 bg-gradient-to-r from-[#f6ab41] to-[#ff4938] text-white rounded-lg hover:from-[#f59e38] hover:to-[#e6432f] transition-all duration-200 cursor-pointer"
            >

...
const Footer = () => {
  return (
    <>
      ...
      <footer
        id="about"
        className="flex flex-col items-center justify-center w-full py-20 bg-gradient-to-b from-[#1f1b5b] to-[#0e0c2e] text-white/80"
      >
        <img className="w-50" src={assets.final_logo} alt="" />
        <p className="mt-4 text-center">
          Copyright © 2025 <a href="https://youtube.com">ZeeAI</a>. All rights
          reserved.
        </p>

        ...
        <div className="flex items-center justify-between">
          ...
          {content && (
            <button
              ...
              className="flex items-center justify-center w-8 h-8 bg-gradient-to-r from-[#417df6] to-[#8e37eb] text-white rounded-lg hover:from-[#3a71e6] hover:to-[#7d32d4] transition-all duration-200 cursor-pointer"
            >
